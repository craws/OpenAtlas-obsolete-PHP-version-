...
$dbstring = 'pgsql:host=' . $host . ';dbname=' . $database;
$conn = new PDO($dbstring, $user, $password);
# Build SQL SELECT statement and return the geometry as a GeoJSON element
$sql = "SELECT object_name as title, object_description as description, public.ST_AsGeoJSON(public.ST_Transform((geom),4326),6) AS geojson FROM openatlas.tbl_gis_polygons";
/*

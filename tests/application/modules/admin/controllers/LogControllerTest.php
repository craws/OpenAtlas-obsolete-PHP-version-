...
class Admin_LogControllerTest extends ControllerTestCase {
    ...
    public function testIndex() {
        ...
        $this->request->setMethod('POST')->setPost(['limit' => 0, 'priority' => 7, 'user_id' => 1]);
        $this->dispatch('admin/log');
    ...
    public function testViewDelete() {
        ...
        $logId = Model_LogMapper::log('debug', 'test', 'testview_and_long_text_for_code_coverage_and_so_on.');
